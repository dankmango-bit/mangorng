...
<head>
  <meta charset="UTF-8">
  <title>Mango Battle Arena</title>
  ...
  <style>
    :root {
      ...
      --highlight: #fff;
      --error: #f33;
      --rainbow: linear-gradient(90deg, #ff005a, #ffb700, #39ff14, #00d2ff, #8000ff, #ff005a);
    }
    html, body {
      min-height: 100vh;
      background: var(--main);
    ...
    <div id="game-section" style="display:none;">
      ...
      <div id="inventory" class="section">
        <div class="center">
          ...
          <input type="text" id="search-mango" placeholder="Search mangoes..." oninput="filterInventory()">
        </div>
